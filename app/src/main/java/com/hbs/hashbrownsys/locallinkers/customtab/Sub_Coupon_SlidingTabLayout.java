...
public class Sub_Coupon_SlidingTabLayout extends HorizontalScrollView {
    ...
    private final Coupon_SlidingTabStrip mTabStrip;

    public Sub_Coupon_SlidingTabLayout(Context context) {
        this(context, null);
    }

    public Sub_Coupon_SlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Sub_Coupon_SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new Coupon_SlidingTabStrip(context);
    ...
    private void populateTabStrip() {
        final Sub_Coupan_Cat_Adapter adapter = (Sub_Coupan_Cat_Adapter) mViewPager.getAdapter();
