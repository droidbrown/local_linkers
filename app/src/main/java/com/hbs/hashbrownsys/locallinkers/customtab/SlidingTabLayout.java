...
public class SlidingTabLayout extends HorizontalScrollView
{
    ...
    private void populateTabStrip()
    {
        ...
        final View.OnClickListener tabClickListener = new TabClickListener();
            ...
            {
                View tabView = null;
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.custom_tab_layout, mTabStrip, false);
              ...
              //  iconImageView.setImageDrawable(getContext().getResources().getDrawable(getDrawableId(i)));
                ...
                FrameLayout frameLayout=(FrameLayout)tabView.findViewById(R.id.tab_iconFL);
                TextView cart_item_count=(TextView)tabView.findViewById(R.id.cartitemcountTV);
                if(getCart_item()>0){
                    if(adapter.getPageTitle(i).equals("Cart")){
                        frameLayout.setVisibility(VISIBLE);
                        cart_item_count.setText(getCart_item()+"");
                    }
                }
