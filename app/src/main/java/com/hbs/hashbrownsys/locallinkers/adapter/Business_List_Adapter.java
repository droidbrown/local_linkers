...
public class Business_List_Adapter extends BaseAdapter {
    ...
    public static class ViewHolder {
        ImageView imageView;
        TextView txt_title;
        TextView txt_name, txt_phone, txt_address, txt_des, txt_distance, txtwebsite;
        TextView btn_book;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.ll_website = (LinearLayout) view.findViewById(R.id.llwebsite);
            viewHolder.txtwebsite = (TextView) view.findViewById(R.id.txt_website_icon);
            viewHolder.txtwebsite.setTypeface(Font);
        ...
        if (array_list.size() <= 0) {
            ...
            if (tempValues.getWebsite().trim().equalsIgnoreCase("")) {
                viewHolder.ll_website.setVisibility(View.GONE);
            } else {
                viewHolder.ll_website.setVisibility(View.VISIBLE);
                viewHolder.txtwebsite.setText(tempValues.getWebsite());
            }
            ...
            Glide.with(activity_new).load("http://www.locallinkers.com/admin/businessimages/" + image_path + "?width=120&height=120&mode=crop").placeholder(R.drawable.placeholder).into(viewHolder.imageView);
