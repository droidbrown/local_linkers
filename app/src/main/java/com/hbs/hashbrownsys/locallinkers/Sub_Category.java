...
public class Sub_Category extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Sub_Category.this, Business_List_Search.class);
    ...
    public void Show_Sub_Category_List()
    {
        ...
        progressDialog = ProgressDialog.show(Sub_Category.this, "", "Checking. Please wait...", false);
        ...
        AsyncTask<Void, Void, String> mregister = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    response = http.getMethods(new JSONObject(), Constants.SUB_CATEGORY_LIST +"?categoryId="+model.getCategoryId()+"&type=Business");
    ...
    public void setTab()
    {
        ...
        adapter = new SubCat_ViewPagerAdapter(this.getSupportFragmentManager(), Titles, Numboftabs);
        pager = (ViewPager) findViewById(R.id.pager);
        tabs = (Sub_SlidingTabLayout) findViewById(R.id.tabs);
        ...
        tabs.setCustomTabColorizer(new Sub_SlidingTabLayout.TabColorizer()
        {
            ...
            public int getIndicatorColor(int position)
            {
                ...
                return  ContextCompat.getColor(Sub_Category.this, R.color.tabsScrollColor);
